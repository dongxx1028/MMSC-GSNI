...
loglog(tD,D_y(:,1),'--','Color',[1, 0, 0], 'Linewidth',1.5)
hold on
loglog(tD,D_y1(:,1),'--','Color',[0.75, 0, 0.75], 'Linewidth',1.5)
hold on
loglog(tD,D_y1(:,2),'--','Color',[0, 0.5, 0], 'Linewidth',1.5)
hold on
loglog(tD,D_y1(:,3),'--','Color',[0, 0, 1], 'Linewidth',1.5)
hold on
...
legend('\beta_{1}=0','\beta_{1}=0.001','\beta_{1}=0.002','\beta_{1}=0.003')
